...
$(function() {
  ...
  Presentation = (function() {
    ...
    Presentation.prototype.setStartButton = function() {
      ...
      return this.target.prev().append($startButton);
    };
    ...
    Presentation.prototype.stopPresentation = function() {
      ...
      return $(this.slides).each(function(slide) {
        return $(slide);
      });
    };
    ...
    Presentation.prototype.nextPage = function() {
      ...
      if (this.slides[pid + 1] != null) {
        return this.slides[pid + 1].addClass('current');
      } else {
    ...
    Presentation.prototype.prevPage = function() {
      ...
      pid = $current.data('pid');
      if (this.slides[pid - 1] != null) {
        return (_ref = this.slides[pid - 1]) != null ? _ref.addClass('current') : void 0;
      } else {
        return this.stopPresentation();
      }
    };
  ...
  return $($('.start-button').get(0)).trigger('click');
});
